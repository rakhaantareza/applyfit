  ...
  return (
    <header className={joinClassNames("page-header", className)}>
      <div className="page-header-copy">
        ...
        {description ? <p className="page-header-description type-helper">{description}</p> : null}
      </div>
  ...
  return (
    <header className={joinClassNames("section-header", className)}>
      <div className="section-header-copy">
        ...
        {description ? <p className="section-header-description type-helper">{description}</p> : null}
      </div>
