...
test("all persisted application mutation routes use the shared Demo guard", async () => {
  const routes = [
    ...
    "../app/api/career-profile/skills/route.ts",
    "../app/api/career-profile/skills/[skillId]/route.ts",
    "../app/api/evidences/route.ts",
    "../app/api/evidences/[evidenceId]/route.ts",
    "../app/api/evidences/[evidenceId]/skills/route.ts",
    "../app/api/evidences/[evidenceId]/skills/[skillId]/route.ts",
